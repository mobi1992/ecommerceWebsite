...
const Shipping = ({checkoutToken, contactInfo, nextStep, prevStep}) => {
       
       checkoutToken.extra_fields[0].meta = contactInfo.phoneNo
       console.log(checkoutToken.extra_fields[0].meta)
    useEffect(() => {
